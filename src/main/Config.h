...
class Config : public std::enable_shared_from_this<Config>
{
  ...
  public:
    ...
    /* custom attributes IMMORT_MARKED */
    std::string ADMIN_ADDRESS;
    long long int BASE_NATIVE_AMOUNT;
    long long int BASE_RESERVE;
    int BASE_RESERVE_INIT;
    bool BASE_RESERVE_ONLY;
    long long int INFLATION_RATE_TRILLIONTHS;
