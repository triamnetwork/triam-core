...
/* IMMORT_MARKED */
/* add function to load selling offers of specific asset, this will be used to check for freezing amount */


void OfferFrame::loadOffersBySellingAsset(AccountID const& accountID, Asset const& selling,
                                 Database& db, std::vector<OfferFrame::pointer>& retOffers){
