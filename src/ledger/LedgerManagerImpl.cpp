...
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_FEE = 10000;
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_RESERVE = 100000000;
const uint32_t LedgerManager::GENESIS_LEDGER_MAX_TX_SIZE = 400;
const int64_t LedgerManager::GENESIS_LEDGER_TOTAL_COINS = 328500000410030000;
...
LedgerManagerImpl::getMinBalance(uint32_t ownerCount) const
{
    ...
    return (mApp.getConfig().BASE_RESERVE_INIT + (mApp.getConfig().BASE_RESERVE_ONLY? 0 : ownerCount)) * int64_t(mCurrentLedger->mHeader.baseReserve);
}
